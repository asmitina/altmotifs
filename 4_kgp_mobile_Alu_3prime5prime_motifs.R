...
tr_info_new = read.delim('KGP.STR.All.tsv')
tr_info_new = tr_info_new[tr_info_new$chr %in% paste0("chr", c(1:22)), ]#10884 - for chr1-22

# repeats = read.delim('repeat_masker.tsv') # 5607738
repeats = read.delim('~/Downloads/UCSC_hg38_repeatMasker.tsv') # 5655664 YES!
repeats =  repeats[repeats$genoName %in% paste0("chr", c(1:22, "M", "X", "Y")), ] # 5317291 YES!
mobile = repeats[repeats$repFamily == 'Alu' | repeats$repClass == 'LINE',] # 2697298 17
...
#tr_test$aluid = paste0(tr_test$genoName, ":", tr_test$genoStart, "-", tr_test$genoEnd)


#### Repeats on 5 prime end of Alu elements 
#Alu dist = 0, which are on 5' from Alu - 601 repeat
...
prime5.all = as.data.frame( table(prime5_motif$dominant.motif)) # 74
...
prime5.st = as.data.frame( table(prime5_motif$dominant.motif[prime5_motif$type == 'stable']))# 40
...
prime5.var = as.data.frame( table(prime5_motif$dominant.motif[prime5_motif$type == 'variable']))
...
pdf('_GTEx/output/figures/_Alu_5prime_all_st_var_COUNT.pdf', w = 3.5, h = 5.5)
par(mar = c(4.5,4,1,1), mgp = c(3,1,0), mfrow=c(3,1)) 
my_bar = barplot(motif.plot$freq, las = 2, main = '', # All STRs at 5\' of Alu elements',
                 col = 'grey', ylim = c(0,110), ylab = 'Frequency')
text(my_bar, y = par("usr")[3]-5,labels = motif.plot$motif,xpd = NA, srt = 90,cex = 0.9,
     adj = 1, srt = 35)#, srt = 35
text(my_bar, motif.plot$freq + 5, paste(motif.plot$freq) ,cex=0.9) 

my_bar = barplot(motif.plot$freq.st, las = 2, main = '', # Stable STRs at 5\' of Alu elements',
                 col = alpha('springgreen2', 0.6), ylim = c(0,110), ylab = 'Frequency') 
text(my_bar, y = par("usr")[3]-5,labels = motif.plot$motif,xpd = NA, srt = 90,cex = 0.9,
     adj = 1, srt = 35)#, srt = 35
text(my_bar, motif.plot$freq.st + 5, paste(motif.plot$freq.st) ,cex=0.9) 

my_bar = barplot(motif.plot$freq.var, las = 2, main = '', # Variable STRs at 5\' of Alu elements',
                 col = alpha('firebrick1', 0.6), ylim = c(0,110), ylab = 'Frequency')
text(my_bar, y = par("usr")[3]-5,labels = motif.plot$motif,xpd = NA, srt = 90,cex = 0.9,
     adj = 1, srt = 35)#, srt = 35
text(my_bar, motif.plot$freq.var + 5, paste(motif.plot$freq.var) ,cex=0.9) 
dev.off()


pdf('_GTEx/output/figures/_Alu_5prime_all_st_var_FREQ_MIR_lab_SIGN_.pdf', w = 3.5, h = 4.5)
par(mar = c(4.5,4,1,1), mgp = c(3,1,0), mfrow=c(3,1)) 
my_bar = barplot(motif.plot$freq/sum(motif.plot$freq), las = 2, main = '', # All STRs at 5\' of Alu elements',
                 col = 'grey', ylim = c(0,0.4), ylab = 'Frequency')
...
my_bar = barplot(motif.plot$freq.st/sum(motif.plot$freq.st), las = 2, main = '', # Stable STRs at 5\' of Alu elements',
                 col = alpha('springgreen2', 0.6), ylim = c(0,0.4), ylab = 'STABLE') 

par(mar=c(5,5,0,3))
my_bar = barplot(motif.plot$freq.var/sum(motif.plot$freq.var), las = 2, main = '', # Variable STRs at 5\' of Alu elements',
                 col = alpha('firebrick1', 0.6), ylim = c(0.4,0), ylab = 'VARIABLE')
text(my_bar-0.5, y = par("usr")[3]+0.05,labels = motif.plot$motif,xpd = NA, srt = 90,cex = 0.9, pos = 4,
     adj = 1, srt = 90)
text(my_bar, y = par("usr")[3]+0.05,labels = ifelse(prime5.all$signif, '*', ''),xpd = NA, srt = 90,cex = 1.5, 
     adj = 1, srt = 90)
dev.off()
...
prime5.all$motif[prime5.all$OR > 1 & prime5.all$Fisher.p < 0.05]
prime5.all$signif = ifelse(prime5.all$OR > 1 & prime5.all$Fisher.p < 0.05, T, F)


### BOXPLOT
prime5_motif = read.delim('_1KGP/output/alu_5prime_motif_st_var.tsv', sep = ' ')
...
pdf('_GTEx/output/figures/_Alu_KGP/_Alu_5prime_boxplot_st_dom_alt__PVAL_.pdf', w = 2.6, h = 4)
par(mar = c(4.5,4,1,1), mgp = c(3,1,0), mfrow=c(1,1)) 
boxplot(gc.stable, gc.var.dom, prime5.alt$gc, col = c(alpha(c('springgreen2', 'grey', 'dodgerblue1'), 0.6)), 
        xaxt = 'n', yaxt = 'n', ylab = 'GC-content', ylim = c(0,1), main = '', outline = F)
...
# text(2.5,0.75, labels = paste0('p = ', format(test.dom.alt$p.value, digits=2)))

dev.off()

pdf('_GTEx/output/figures/_Alu_KGP/_Alu_5prime_boxplot_st_dom_alt__PVAL_COLOR_ALL.pdf', w = 2.6, h = 4)#, h = 7
par(mar = c(4.5,4,1,1), mgp = c(3,1,0), mfrow=c(1,1)) 
boxplot(gc.stable, gc.var.dom, prime5.alt$gc, col = c(alpha(c('springgreen2', 'firebrick1', 'dodgerblue1'), 0.6)), 
        xaxt = 'n', yaxt = 'n', ylab = 'GC-content', ylim = c(0,1), main = '', outline = F)
axis(1, at = c(1,2,3), labels = c('ST', 'DOM', 'ALT'))
axis(2, at = seq(0,1,0.2), las = 2)
...
test.st.var = wilcox.test(gc.stable, gc.variable)
pdf('_GTEx/output/figures/_Alu_KGP/_Alu_5prime_boxplot_st_var_PVAL_.pdf', w = 2.6, h = 4)#, h = 7
...
### NOW DO THE SAME FOR 3' Alu
write.table(prime5.all, '_1KGP/output/alu_5prime_motif_freq_st_var.tsv', quote = F, col.names = T, row.names = F)
write.table(prime5_motif, '_1KGP/output/alu_5prime_motif_st_var.tsv', quote = F, col.names = T, row.names = F)

write.table(prime3.all, '_1KGP/output/alu_3prime_motif_freq_st_var.tsv', quote = F, col.names = T, row.names = F)
write.table(prime3_motif, '_1KGP/output/alu_3prime_motif_st_var.tsv', quote = F, col.names = T, row.names = F)


#### HERE
#### Repeats on 3 prime end of Alu elements 
#Alu dist = 0, which are on 3' from Alu - 1026 repeat
...
prime3_motif = prime3[which(prime3$tr_strand == '-' | prime3$tr_strand == '+'),]#803
prime3_motif = prime3_motif[which(prime3_motif$tr_strand == prime3_motif$tr_strand_),]#693
...
prime3.var = as.data.frame( table(prime3_motif$dominant.motif[prime3_motif$type == 'variable']))
...
### PLOT - All - ST - VAR
motif.plot = prime3.all[prime3.all$freq > 1,]

pdf('_GTEx/output/figures/_Alu_3prime_all_st_var_COUNT.pdf', w = 4, h = 6.5)#, h = 7
par(mar = c(4.5,4,1,1), mgp = c(3,1,0), mfrow=c(3,1)) 
my_bar = barplot(motif.plot$freq, las = 2, main = '', # All STRs at 5\' of Alu elements',
                 col = 'grey', ylim = c(0,280), ylab = 'Frequency')
text(my_bar, y = par("usr")[3]-10,labels = motif.plot$motif,xpd = NA, srt = 90,cex = 0.9,
     adj = 1, srt = 35)#, srt = 35
text(my_bar, motif.plot$freq + 15, paste(motif.plot$freq) ,cex=0.9) 

my_bar = barplot(motif.plot$freq.st, las = 2, main = '', # Stable STRs at 5\' of Alu elements',
                 col = alpha('springgreen2', 0.6), ylim = c(0,280), ylab = 'Frequency') 
text(my_bar, y = par("usr")[3]-10,labels = motif.plot$motif,xpd = NA, srt = 90,cex = 0.9,
     adj = 1, srt = 35)#, srt = 35
text(my_bar, motif.plot$freq.st + 15, paste(motif.plot$freq.st) ,cex=0.9) 

my_bar = barplot(motif.plot$freq.var, las = 2, main = '', # Variable STRs at 5\' of Alu elements',
                 col = alpha('firebrick1', 0.6), ylim = c(0,280), ylab = 'Frequency')
text(my_bar, y = par("usr")[3]-10,labels = motif.plot$motif,xpd = NA, srt = 90,cex = 0.9,
     adj = 1, srt = 35)#, srt = 35
text(my_bar, motif.plot$freq.var + 15, paste(motif.plot$freq.var) ,cex=0.9) 
dev.off()


pdf('_GTEx/output/figures/_Alu_3prime_all_st_var_FREQ_MIR_lab_SIGN_.pdf', w = 3.5, h = 4.5)
par(mar = c(4.5,4,1,1), mgp = c(3,1,0), mfrow=c(3,1)) 
my_bar = barplot(motif.plot$freq/sum(motif.plot$freq), las = 2, main = '', # All STRs at 5\' of Alu elements',
                 col = 'grey', ylim = c(0,0.4), ylab = 'Frequency')
text(my_bar, y = par("usr")[3]-0.02,labels = motif.plot$motif,xpd = NA, srt = 90,cex = 0.9,
...
my_bar = barplot(motif.plot$freq.var/sum(motif.plot$freq.var), las = 2, main = '', # Variable STRs at 5\' of Alu elements',
                 col = alpha('firebrick1', 0.6), ylim = c(0.4,0), ylab = 'VARIABLE')
text(my_bar-0.5, y = par("usr")[3]+0.28,labels = motif.plot$motif,xpd = NA, srt = 90,cex = 0.9, pos = 4,
     adj = 1, srt = 90)
text(my_bar, y = par("usr")[3]+0.28,labels = ifelse(prime3.all$signif, '*', ''),xpd = NA, srt = 90,cex = 1.5,
     adj = 1, srt = 90)
dev.off()
...
### BOXPLOT
prime3_motif = read.delim('_1KGP/output/alu_3prime_motif_st_var.tsv', sep = ' ')
...
pdf('_GTEx/output/figures/_Alu_KGP/_Alu_3prime_boxplot_st_dom_alt__PVAL_COLOR_ALL_.pdf', w = 2.6, h = 4)#, h = 7
par(mar = c(4.5,4,1,1), mgp = c(3,1,0), mfrow=c(1,1)) 
...
axis(1, at = c(1,2,3), labels = c('ST', 'VAR', 'ALT'))
axis(2, at = seq(0,1,0.2), las = 2)
...
pdf('_GTEx/output/figures/_Alu_KGP/_Alu_3prime_boxplot_st_var__PVAL.pdf', w = 2.6, h = 4)#, h = 7
par(mar = c(5,4,1,1), mgp = c(3,1,0), mfrow=c(1,1)) 
boxplot(gc.stable, gc.variable, col = c(alpha(c('springgreen2', 'firebrick1'), 0.6)), 
        xaxt = 'n', yaxt = 'n', ylab = 'GC-content')
axis(1, at = c(1,2), labels = c('ST', 'VAR'))
